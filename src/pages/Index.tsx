  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Experience seamless rides with RideX. AI-powered driver matching, real-time tracking, and unmatched safety features. Book your ride in seconds." 
        />
      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="pt-16 md:pt-20">
          ...
          {currentView === "driver" && (
            <DriverDashboard onBack={() => handleNavigate("home")} />
          )}
        </main>
      </div>
    </>
